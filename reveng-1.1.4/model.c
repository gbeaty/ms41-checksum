...
static const bmp_t b40a[] = {
	BMP_C(0x2be9b039) << (BMP_BIT - 32) | BMP_C(0x5c) >> (39 - BMP_BIT),
	BMP_C(0xb9) << (BMP_BIT * 2 - 40),
};
#    endif /* BMP_BIT */
...
static const bmp_t b32[] = {
	...
	BMP_C(0xbd0be338) << (BMP_BIT - 32),	/*  88 -- 32,bd0be338 */
	BMP_C(0xbf050000) << (BMP_BIT - 32),	/*  89 -- 16,    bf05 */
	BMP_C(0xc0000000) << (BMP_BIT - 32),	/*  90 --  3,       6 */
	BMP_C(0xc2b70000) << (BMP_BIT - 32),	/*  91 -- 16,    c2b7 */
	BMP_C(0xc6c60000) << (BMP_BIT - 32),	/*  92 -- 16,    c6c6 */
	BMP_C(0xc8000000) << (BMP_BIT - 32),	/*  93 --  5,      19 */
	BMP_C(0xc8670000) << (BMP_BIT - 32),	/*  94 -- 16,    c867 */
	BMP_C(0xcbf43926) << (BMP_BIT - 32),	/*  95 -- 32,cbf43926 */
	BMP_C(0xd0000000) << (BMP_BIT - 32),	/*  96 --  8,      d0 */
	BMP_C(0xd02a0000) << (BMP_BIT - 32),	/*  97 -- 15,    6815 */
	BMP_C(0xd0db0000) << (BMP_BIT - 32),	/*  98 -- 16,    d0db */
	BMP_C(0xd4d00000) << (BMP_BIT - 32),	/*  99 -- 12,     d4d */
	BMP_C(0xd64e0000) << (BMP_BIT - 32),	/* 100 -- 16,    d64e */
	BMP_C(0xda000000) << (BMP_BIT - 32),	/* 101 --  8,      da */
	BMP_C(0xdaf00000) << (BMP_BIT - 32),	/* 102 -- 12,     daf */
	BMP_C(0xe0000000) << (BMP_BIT - 32),	/* 103 --  3,       7 */
	BMP_C(0xe3069283) << (BMP_BIT - 32),	/* 104 -- 32,e3069283 */
	BMP_C(0xe5cc0000) << (BMP_BIT - 32),	/* 105 -- 16,    e5cc */
	BMP_C(0xe7a80000) << (BMP_BIT - 32),	/* 106 -- 13,    1cf5 */
	BMP_C(0xea000000) << (BMP_BIT - 32),	/* 107 --  7,      75 */
	BMP_C(0xea820000) << (BMP_BIT - 32),	/* 108 -- 16,    ea82 */
	BMP_C(0xec000000) << (BMP_BIT - 32),	/* 109 --  6,      3b */
	BMP_C(0xf1300000) << (BMP_BIT - 32),	/* 110 -- 12,     f13 */
	BMP_C(0xf4000000) << (BMP_BIT - 32),	/* 111 --  8,      f4 */
	BMP_C(0xf5b00000) << (BMP_BIT - 32),	/* 112 -- 12,     f5b */
	BMP_C(0xf6400000) << (BMP_BIT - 32),	/* 113 -- 10,     3d9 */
	BMP_C(0xf8000000) << (BMP_BIT - 32),	/* 114 --  5,      1f */
	BMP_C(0xfc000000) << (BMP_BIT - 32),	/* 115 --  6,      3f */
	BMP_C(0xfc891918) << (BMP_BIT - 32),	/* 116 -- 32,fc891918 */
	BMP_C(0xfd000000) << (BMP_BIT - 32),	/* 117 --  8,      fd */
	BMP_C(0xfe000000) << (BMP_BIT - 32),	/* 118 --  7,      7f */
	BMP_C(0xfedcba00) << (BMP_BIT - 32),	/* 119 -- 24,  fedcba */
	BMP_C(0xfee80000) << (BMP_BIT - 32),	/* 120 -- 16,    fee8 */
	BMP_C(0xff000000) << (BMP_BIT - 32),	/* 121 --  8,      ff */
	BMP_C(0xffc00000) << (BMP_BIT - 32),	/* 122 -- 10,     3ff */
	BMP_C(0xfff00000) << (BMP_BIT - 32),	/* 123 -- 12,     fff */
	BMP_C(0xffff0000) << (BMP_BIT - 32),	/* 124 -- 16,    ffff */
	BMP_C(0xfffffffe) << (BMP_BIT - 32),	/* 125 -- 31,7fffffff */
	BMP_C(0xffffffff) << (BMP_BIT - 32),	/* 126 -- 32,ffffffff */
};
...
static const model_t models[] = {
	{{32UL, b32+  1}, PZERO,           P_BE,   PZERO,           {32UL, b32+ 88}, "XFER"              },	/*  0 */
	{{40UL, b40    }, PZERO,           P_BE,   PZERO,           {40UL, b40a   }, "CRC-40/GSM"        },	/*  1 */
	{{32UL, b32+  8}, PZERO,           P_BE,   {32UL, b32+126}, {32UL, b32+ 57}, "CRC-32/POSIX"      },	/*  2 */
	{{32UL, b32+  8}, {32UL, b32+126}, P_BE,   PZERO,           {32UL, b32+  7}, "CRC-32/MPEG-2"     },	/*  3 */
	{{32UL, b32+  8}, {32UL, b32+126}, P_BE,   {32UL, b32+126}, {32UL, b32+116}, "CRC-32/BZIP2"      },	/*  4 */
	{{32UL, b32+  8}, {32UL, b32+126}, P_LE,   PZERO,           {32UL, b32+ 39}, "JAMCRC"            },	/*  5 */
	{{32UL, b32+  8}, {32UL, b32+126}, P_LE,   {32UL, b32+126}, {32UL, b32+ 95}, "CRC-32"            },	/*  6 */
	{{16UL, b32+  9}, PZERO,           P_BE,   PZERO,           {16UL, b32+  5}, "CRC-16/DECT-X"     },	/*  7 */
	{{16UL, b32+  9}, PZERO,           P_BE,   {16UL, b32+  2}, {16UL, b32+  4}, "CRC-16/DECT-R"     },	/*  8 */
	{{ 8UL, b32+ 10}, PZERO,           P_BE,   PZERO,           { 8UL, b32+111}, "CRC-8"             },	/*  9 */
	{{ 8UL, b32+ 10}, PZERO,           P_BE,   { 8UL, b32+ 48}, { 8UL, b32+ 78}, "CRC-8/ITU"         },	/* 10 */
	{{ 8UL, b32+ 10}, { 8UL, b32+121}, P_LE,   PZERO,           { 8UL, b32+ 96}, "CRC-8/ROHC"        },	/* 11 */
	{{31UL, b32+ 11}, {31UL, b32+125}, P_BE,   {31UL, b32+125}, {31UL, b32+ 19}, "CRC-31/PHILIPS"    },	/* 12 */
	{{ 6UL, b32+ 13}, PZERO,           P_LE,   PZERO,           { 6UL, b32+ 18}, "CRC-6/ITU"         },	/* 13 */
	{{82UL, b82    }, PZERO,           P_LE,   PZERO,           {82UL, b82a   }, "CRC-82/DARC"       },	/* 14 */
	{{16UL, b32+ 15}, PZERO,           P_BE,   PZERO,           {16UL, b32+ 37}, "XMODEM"            },	/* 15 */
	{{16UL, b32+ 15}, PZERO,           P_LE,   PZERO,           {16UL, b32+ 27}, "KERMIT"            },	/* 16 */
	{{16UL, b32+ 15}, {16UL, b32+ 22}, P_BE,   PZERO,           {16UL, b32+105}, "CRC-16/AUG-CCITT"  },	/* 17 */
	{{16UL, b32+ 15}, {16UL, b32+ 66}, P_LE,   PZERO,           {16UL, b32+ 30}, "CRC-16/TMS37157"   },	/* 18 */
	{{16UL, b32+ 15}, {16UL, b32+ 83}, P_LE,   PZERO,           {16UL, b32+ 51}, "CRC-16/RIELLO"     },	/* 19 */
	{{16UL, b32+ 15}, {16UL, b32+ 92}, P_LE,   PZERO,           {16UL, b32+ 89}, "CRC-A"             },	/* 20 */
	{{16UL, b32+ 15}, {16UL, b32+124}, P_BE,   PZERO,           {16UL, b32+ 33}, "CRC-16/CCITT-FALSE"},	/* 21 */
	{{16UL, b32+ 15}, {16UL, b32+124}, P_BE,   {16UL, b32+124}, {16UL, b32+100}, "CRC-16/GENIBUS"    },	/* 22 */
	{{16UL, b32+ 15}, {16UL, b32+124}, P_LE,   PZERO,           {16UL, b32+ 54}, "CRC-16/MCRF4XX"    },	/* 23 */
	{{16UL, b32+ 15}, {16UL, b32+124}, P_LE,   {16UL, b32+124}, {16UL, b32+ 70}, "X-25"              },	/* 24 */
	{{ 7UL, b32+ 16}, PZERO,           P_BE,   PZERO,           { 7UL, b32+107}, "CRC-7"             },	/* 25 */
	{{ 6UL, b32+ 20}, { 6UL, b32+115}, P_BE,   PZERO,           { 6UL, b32+109}, "CRC-6/CDMA2000-B"  },	/* 26 */
	{{ 8UL, b32+ 21}, { 8UL, b32+117}, P_BE,   PZERO,           { 8UL, b32+ 59}, "CRC-8/I-CODE"      },	/* 27 */
	{{ 8UL, b32+ 21}, { 8UL, b32+121}, P_LE,   PZERO,           { 8UL, b32+ 71}, "CRC-8/EBU"         },	/* 28 */
	{{32UL, b32+ 23}, {32UL, b32+126}, P_LE,   {32UL, b32+126}, {32UL, b32+104}, "CRC-32C"           },	/* 29 */
	{{14UL, b32+ 25}, PZERO,           P_LE,   PZERO,           {14UL, b32+ 26}, "CRC-14/DARC"       },	/* 30 */
	{{ 5UL, b32+ 32}, { 5UL, b32+114}, P_LE,   { 5UL, b32+114}, { 5UL, b32+ 93}, "CRC-5/USB"         },	/* 31 */
	{{ 4UL, b32+ 34}, PZERO,           P_LE,   PZERO,           { 4UL, b32+ 55}, "CRC-4/ITU"         },	/* 32 */
	{{ 8UL, b32+ 36}, PZERO,           P_LE,   PZERO,           { 8UL, b32+ 78}, "CRC-8/MAXIM"       },	/* 33 */
	{{ 8UL, b32+ 41}, PZERO,           P_LE,   PZERO,           { 8UL, b32+ 17}, "CRC-8/DARC"        },	/* 34 */
	{{16UL, b32+ 42}, PZERO,           P_BE,   {16UL, b32+124}, {16UL, b32+ 91}, "CRC-16/EN-13757"   },	/* 35 */
	{{16UL, b32+ 42}, PZERO,           P_LE,   {16UL, b32+124}, {16UL, b32+108}, "CRC-16/DNP"        },	/* 36 */
	{{64UL, b64    }, PZERO,           P_BE,   PZERO,           {64UL, b64a   }, "CRC-64"            },	/* 37 */
	{{64UL, b64    }, {64UL, b64b   }, P_BE,   {64UL, b64b   }, {64UL, b64c   }, "CRC-64/WE"         },	/* 38 */
	{{64UL, b64    }, {64UL, b64b   }, P_LE,   {64UL, b64b   }, {64UL, b64d   }, "CRC-64/XZ"         },	/* 39 */
	{{ 5UL, b32+ 44}, { 5UL, b32+ 44}, P_BE,   PZERO,           { 5UL, b32+  0}, "CRC-5/EPC"         },	/* 40 */
	{{24UL, b32+ 49}, {24UL, b32+ 82}, P_BE,   PZERO,           {24UL, b32+ 24}, "CRC-24/FLEXRAY-B"  },	/* 41 */
	{{24UL, b32+ 49}, {24UL, b32+119}, P_BE,   PZERO,           {24UL, b32+ 58}, "CRC-24/FLEXRAY-A"  },	/* 42 */
	{{ 3UL, b32+ 50}, { 3UL, b32+103}, P_LE,   PZERO,           { 3UL, b32+ 90}, "CRC-3/ROHC"        },	/* 43 */
	{{ 6UL, b32+ 52}, PZERO,           P_LE,   PZERO,           { 6UL, b32+ 72}, "CRC-6/DARC"        },	/* 44 */
	{{11UL, b32+ 56}, {11UL, b32+  6}, P_BE,   PZERO,           {11UL, b32+ 84}, "CRC-11"            },	/* 45 */
	{{16UL, b32+ 60}, PZERO,           P_BE,   PZERO,           {16UL, b32+120}, "CRC-16/BUYPASS"    },	/* 46 */
	{{16UL, b32+ 60}, PZERO,           P_LE,   PZERO,           {16UL, b32+ 87}, "ARC"               },	/* 47 */
	{{16UL, b32+ 60}, PZERO,           P_LE,   {16UL, b32+124}, {16UL, b32+ 43}, "CRC-16/MAXIM"      },	/* 48 */
	{{16UL, b32+ 60}, {16UL, b32+ 61}, P_BE,   PZERO,           {16UL, b32+ 76}, "CRC-16/DDS-110"    },	/* 49 */
	{{16UL, b32+ 60}, {16UL, b32+124}, P_LE,   PZERO,           {16UL, b32+ 46}, "MODBUS"            },	/* 50 */
	{{16UL, b32+ 60}, {16UL, b32+124}, P_LE,   {16UL, b32+124}, {16UL, b32+ 85}, "CRC-16/USB"        },	/* 51 */
	{{12UL, b32+ 62}, PZERO,           P_BE,   PZERO,           {12UL, b32+112}, "CRC-12/DECT"       },	/* 52 */
	{{12UL, b32+ 62}, PZERO,           P_BELE, PZERO,           {12UL, b32+102}, "CRC-12/3GPP"       },	/* 53 */
	{{32UL, b32+ 63}, PZERO,           P_BE,   PZERO,           {32UL, b32+ 35}, "CRC-32Q"           },	/* 54 */
	{{24UL, b32+ 64}, {24UL, b32+ 86}, P_BE,   PZERO,           {24UL, b32+ 28}, "CRC-24"            },	/* 55 */
	{{15UL, b32+ 67}, PZERO,           P_BE,   PZERO,           {15UL, b32+ 12}, "CRC-15"            },	/* 56 */
	{{16UL, b32+ 68}, PZERO,           P_BE,   PZERO,           {16UL, b32+ 98}, "CRC-16/T10-DIF"    },	/* 57 */
	{{10UL, b32+ 69}, PZERO,           P_BE,   PZERO,           {10UL, b32+ 53}, "CRC-10"            },	/* 58 */
	{{ 8UL, b32+ 73}, PZERO,           P_LE,   PZERO,           { 8UL, b32+ 29}, "CRC-8/WCDMA"       },	/* 59 */
	{{ 8UL, b32+ 73}, { 8UL, b32+121}, P_BE,   PZERO,           { 8UL, b32+101}, "CRC-8/CDMA2000"    },	/* 60 */
	{{ 6UL, b32+ 74}, { 6UL, b32+115}, P_BE,   PZERO,           { 6UL, b32+ 38}, "CRC-6/CDMA2000-A"  },	/* 61 */
	{{ 7UL, b32+ 75}, { 7UL, b32+118}, P_LE,   PZERO,           { 7UL, b32+ 79}, "CRC-7/ROHC"        },	/* 62 */
	{{16UL, b32+ 77}, PZERO,           P_BE,   PZERO,           {16UL, b32+ 14}, "CRC-16/TELEDISK"   },	/* 63 */
	{{ 5UL, b32+ 80}, PZERO,           P_LE,   PZERO,           { 5UL, b32+ 40}, "CRC-5/ITU"         },	/* 64 */
	{{32UL, b32+ 81}, {32UL, b32+126}, P_LE,   {32UL, b32+126}, {32UL, b32+ 65}, "CRC-32D"           },	/* 65 */
	{{16UL, b32+ 94}, {16UL, b32+124}, P_BE,   PZERO,           {16UL, b32+ 47}, "CRC-16/CDMA2000"   },	/* 66 */
	{{15UL, b32+ 97}, PZERO,           P_BE,   {15UL, b32+  3}, {15UL, b32+ 45}, "CRC-15/MPT1327"    },	/* 67 */
	{{13UL, b32+106}, PZERO,           P_BE,   PZERO,           {13UL, b32+ 31}, "CRC-13/BBC"        },	/* 68 */
	{{12UL, b32+110}, {12UL, b32+123}, P_BE,   PZERO,           {12UL, b32+ 99}, "CRC-12/CDMA2000"   },	/* 69 */
	{{10UL, b32+113}, {10UL, b32+122}, P_BE,   PZERO,           {10UL, b32+ 69}, "CRC-10/CDMA2000"   },	/* 70 */
	{PZERO,           PZERO,           P_BE,   PZERO,           PZERO,           NULL                },	/* terminating entry */
};
#    define NPRESETS 71

/* List of names with pointers to models, pre-sorted for use with bsearch() */
static struct malias {
	const char *name;
	const model_t *model;
	const int isprimry;
} const aliases[] = {
	...
	{"CRC-10/CDMA2000",	models+70, 1},	/*  4 */
	{"CRC-11",		models+45, 1},	/*  5 */
	{"CRC-12/3GPP",		models+53, 1},	/*  6 */
	{"CRC-12/CDMA2000",	models+69, 1},	/*  7 */
	{"CRC-12/DECT",		models+52, 1},	/*  8 */
	{"CRC-13/BBC",		models+68, 1},	/*  9 */
	...
	{"CRC-8",		models+ 9, 1},	/* 75 */
	{"CRC-8/CDMA2000",	models+60, 1},	/* 76 */
	{"CRC-8/DARC",		models+34, 1},	/* 77 */
	{"CRC-8/EBU",		models+28, 1},	/* 78 */
	{"CRC-8/I-CODE",	models+27, 1},	/* 79 */
	{"CRC-8/ITU",		models+10, 1},	/* 80 */
	{"CRC-8/MAXIM",		models+33, 1},	/* 81 */
	{"CRC-8/ROHC",		models+11, 1},	/* 82 */
	{"CRC-8/WCDMA",		models+59, 1},	/* 83 */
	{"CRC-82/DARC",		models+14, 1},	/* 84 */
	{"CRC-A",		models+20, 1},	/* 85 */
	{"CRC-B",		models+24, 0},	/* 86 */
	{"CRC-CCITT",		models+16, 0},	/* 87 */
	{"CRC-IBM",		models+47, 0},	/* 88 */
	{"DOW-CRC",		models+33, 0},	/* 89 */
	{"JAMCRC",		models+ 5, 1},	/* 90 */
	{"KERMIT",		models+16, 1},	/* 91 */
	{"MODBUS",		models+50, 1},	/* 92 */
	{"PKZIP",		models+ 6, 0},	/* 93 */
	{"R-CRC-16",		models+ 8, 0},	/* 94 */
	{"X-25",		models+24, 1},	/* 95 */
	{"X-CRC-12",		models+52, 0},	/* 96 */
	{"X-CRC-16",		models+ 7, 0},	/* 97 */
	{"XFER",		models+ 0, 1},	/* 98 */
	{"XMODEM",		models+15, 1},	/* 99 */
	{"ZMODEM",		models+15, 0},	/*100 */
